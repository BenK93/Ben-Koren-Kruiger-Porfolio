        ...
        <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
            <div className="max-w-6xl mx-auto">
                <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
                    <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-500 mt-4 my-0 md:my-0 md:text-white dark:text-gray-600 text-center pb-10">
                        Top Projects
                    </h1>
                    <Link href="/projects">
                ...
                <div className="grid md:grid-cols-3 gap-8 lg:-mt-2 pb-5">
                    ...
                    >
                        <div className="relative rounded-lg overflow-hidden">
                            <img
                                src="https://user-images.githubusercontent.com/21170255/139416090-f04dcfca-c286-45c0-95f3-cc24e404d6d9.png"
                                alt="portfolio"
                                className="transform hover:scale-125 transition duration-2000 ease-out"
                            />
                            <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-blue-300 rounded-md px-2">
                                Get That Text - Free OCR
                            </h1>
                            <h1 className="absolute bottom-10 left-10 text-gray-50 font-bold text-xl">
                                01
                            </h1>
                    ...
                    >
                        <div className="relative rounded-lg overflow-hidden">
                            ...
                            <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-pink-500 rounded-md px-2">
                                Graph Traversal - By Dima Tchenak & Ben Koren Kruiger
                            </h1>
                            <h1 className="absolute bottom-10 left-10 text-gray-50 font-bold text-xl">
                                02
                            </h1>
